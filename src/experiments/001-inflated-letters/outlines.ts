 ...
 * plus true holes automatically — no manual winding-rule bookkeeping),
 * simplified with Ramer-Douglas-Peucker, and then had extra points
 * re-inserted along any edge left longer than ~9px on screen — RDP alone
 * can leave long, sparse, nearly-straight runs, which is exactly the gap a
 * neighboring letter's collision point could otherwise slip into
 * undetected. Coordinates are normalized to 0..width, 0..1 (y-down).
 *
